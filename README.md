...
- heatmap.py: Generate player heatmap from detection and homography data.
...
**Before running, download the demo video from [Google Drive](https://drive.google.com/file/d/1xGRWWmyJcZfAnTErgTYfUiYyKPoL_wKX/view?usp=drive_link) or [Google Drive 1080p](https://drive.google.com/file/d/1_aX2TaTak_rJoTQrg4BKqJvXExJ-pXEx/view) and save it into "./data/video/demo.mp4".**
